  ...
  const categories = [
    {
      ...
      description:
        'We protect sensitive data and help you stay compliant with global insurance standards.',
    },
    {
      icon: <SlidersHorizontal className="h-8 w-8 text-white" />,
      title: 'Customizable Platform',
      description:
        'Easily adapt the platform to your needs with flexible workflows and branded modules.',
    },
    {
      icon: <FileText className="h-8 w-8 text-white" />,
      title: 'Paperless Experience',
      description:
        'Simplify your operations with fast, secure digital processes—no paperwork needed.',
    },
    {
      icon: <Network className="h-8 w-8 text-white" />,
      title: 'Seamless Integration',
      description:
        'Connect your systems using our modern APIs for real-time, frictionless syncing.',
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        'AI-powered checks to detect forgeries, mismatches, and alterations across all insurance documents.',
      features: [
    ...
    },
    {
      ...
      description:
        'Multi-layered identity protection that prevents fraud and streamlines KYC compliance.',
      features: [
        'Biometric Matching',
    ...
    },
    {
      ...
      description:
        'Stay ahead of regulatory requirements with secure infrastructure and encrypted storage.',
      features: [
    ...
    },
    {
      ...
      description:
        'Easily plug into your ecosystem using our developer-friendly APIs and white-label modules.',
      features: [
        'RESTful API Access',
        'SDK & Dev Tools',
        'Custom Integrations',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-12">
          {services.map((service, index) => (
            ...
            >
              <div
                className={`bg-gradient-to-br ${service.bgColor} text-white p-8 md:w-1/3 flex flex-col justify-center`}
              >
              ...
              <div className="p-8 md:w-2/3 bg-white">
                <h4 className="text-base font-semibold mb-4 text-gray-800 uppercase tracking-wide">
                  Key Features
                </h4>
